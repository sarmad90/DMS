...
function uploadBlob(blob, uploadUrl, attachmentId, options) {
  ...
  // {
  //   var project= $('#attachments_project').val();
  //   uploadUrl = uploadUrl + '?attachment_id=' + attachmentId + "&project=" + project;
  // }
  // if ($('#attachment_identifier').val()=="id_document")
  // {
  //   uploadUrl = uploadUrl + '?attachment_id=' + attachmentId;
  // }
  // if ( $('#attachments_project').val()!="" )
  //   {
  //     var project= $('#attachments_project').val();
  //     uploadUrl = uploadUrl + '?attachment_id=' + attachmentId + "&project=" + project;
  //   }
  ...
  //     uploadUrl = uploadUrl + '?attachment_id=' + attachmentId;
  //   }
  uploadUrl = uploadUrl + '?attachment_id=' + attachmentId + "&project=" + project + "&attachment_identifier=" + attachment_identifier;
